...
class NotificationsController extends GetxController {
  ...
  Future<void>getNotifications()async{
    ...
    try {
      ...
      if(response!=null){
        ...
        Get.find<AppbarController>().notificationsModel.value=notificationsModel.value;
  ...
  void markAsRead({required String notificationId})async {
    var endPoint=APIEndPoints.markAsReadNotification.replaceAll("{notificationId}", notificationId);
